    ...
    return (
      ...
      >
        ...
        <div className={!slideMode ? classes.container : ''}>
          <Typography component="h2" variant="h2" gutterBottom>NightOwl Productions</Typography>
          <Typography component="p" variant="h5" gutterBottom>Band Managment Software </Typography>
